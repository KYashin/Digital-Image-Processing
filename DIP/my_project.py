...
"}")
        ...
        self.label_contrast.setGeometry(QtCore.QRect(10, 30, 241, 20))
...
"}")
        ...
        self.horizontalSlider_gamma.setMaximum(500)
...
"}")
        ...
        self.label_contrast_video.setGeometry(QtCore.QRect(10, 50, 241, 20))
...
"}")
        ...
        self.horizontalSlider_gamma_video.setMaximum(500)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_contrast.setText(_translate("MainWindow", "Выбор коэффициента контраста (от 0 до 2):"))
        ...
        self.label_contrast_video.setText(_translate("MainWindow", "Выбор коэффициента контраста (от 0 до 2):"))
    ...
    def update_brightness_slider(self):
        ...
        try:
            ...
            if -150 <= value <= 150:  # Проверяем, что значение в допустимом диапазоне
                ...
                msg.setInformativeText("Введите целое чсило от -150 до 150.")  # Подтекст
    ...
    def update_binarization_slider(self):
            ...
            try:
                    ...
                    if 0 <= value <= 255:  # Проверяем, что значение в допустимом диапазоне
                            ...
                            # Если значение вне диапазона, вернуть предыдущее значениe
                            self.ui.lineEdit_binarization.setText(f"{self.current_brightness}")
                            self.ui.horizontalSlider_binarization.setValue(self.current_brightness)
            except ValueError:
                    # Если введено некорректное значение, вернуть предыдущее значение
                    self.ui.lineEdit_binarization.setText(f"{self.current_brightness}")
                    # И можно вернуть слайдер в предыдущее состояние
